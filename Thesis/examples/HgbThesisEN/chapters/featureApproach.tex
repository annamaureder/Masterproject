...
\begin{figure}[H]
	\centering\small
	\begin{tabular}{ccc}
		\fbox{\includegraphics[width=0.40\textwidth]{jointRotation_before}} &	
		\fbox{\includegraphics[width=0.40\textwidth]{jointRotation_after}}  &	
		\fbox{\includegraphics[width=0.40\textwidth]{detectedRigidPart}} 
		\\
		(a) & (b) & (c)
	\end{tabular}
	\caption{Taking an articulated object (puppet) in two different poses $C_1$ (a) and $C_2$ (b) in form of a 2D point cloud representing its hull point cloud as input.} 
