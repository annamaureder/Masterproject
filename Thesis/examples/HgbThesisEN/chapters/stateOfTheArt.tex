...
\begin{figure}[H]
	\centering\small
	\begin{tabular}{cc}
		\fbox{\includegraphics[width=0.45\textwidth]{stanfordBunny}} &
...
\begin{figure}[H]
	\centering\small
	\begin{tabular}{cc}
		\fbox{\includegraphics[width=0.53\textwidth]{ShapeCorrespondences2}} &
		\fbox{\includegraphics[width=0.37\textwidth]{ShapeCorrespondences}} 
		\\
		(a) & (b) 
	\end{tabular}
...
%
%TODO: add scanning references + scanning software.
%
...
%%
%TODO: add important references for object model

\begin{figure}[H]
	\centering\small
	\begin{tabular}{cc}
		\fbox{\includegraphics[width=0.41\textwidth]{CSP1}} &
		\fbox{\includegraphics[width=0.49\textwidth]{CSP2}} 
		\\
		(a) & (b) 
	\end{tabular}
...
%TODO: add important references for machine learning.
