...
\section{Estimate pose of puppet}
It has to be known 
...
- which joint/rigid parts correspondence in two successive poses

\section{General pose capture approach}
...
There are previous approaches with markers and sensors which will not be treated in this work in detail, as markerless options are taken as focus.
