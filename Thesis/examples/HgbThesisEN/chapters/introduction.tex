...
Pose and motion estimation of objects is an active field of research due to the growing digitalization of day-to-day processes. %TODO: Write more about pose capture! --> see papers, puppet pose capture!
