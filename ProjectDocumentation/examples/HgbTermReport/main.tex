...
\begin{document}
	...
	\end{figure}
	The segmentation into rigid parts is also apparent, when visualizing the registration between $C_{1,0}$ and $C_{2,0}$. Two associated points from $C_{1,0}$ and $C_{2,0}$ are thereby linked with green lines. Comparing the registration results before and after a segmentation into rigid parts clearly shows, that the registration of rigid parts with the ICP results in a lower matching error $e$.
